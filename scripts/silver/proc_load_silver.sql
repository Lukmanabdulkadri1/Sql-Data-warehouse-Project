...
BEGIN
	...
	*,
	...
	-- Loading silver.erp_CUST_A12 
	SET @start_time=GETDATE();
	PRINT '>> Truncating Table: silver.erp_CUST_A12';
	TRUNCATE TABLE silver.erp_CUST_A12;
	PRINT '>> Inserting Data Into: silver.erp_CUST_A12';

	INSERT INTO silver.erp_CUST_A12(
		   CID,
		   BDATE,
		   GEN
	)
