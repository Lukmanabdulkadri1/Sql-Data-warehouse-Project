...
============================================================================
Script Purpose: 
  This script creates Tables in the 'silver' schema, drooping existing tables
...
IF OBJECT_ID ('silver.erp_CUST_A12') IS NOT NULL
	DROP TABLE silver.erp_CUST_A12
CREATE TABLE silver.erp_CUST_A12(
	CID NVARCHAR(50),
	BDATE DATE,
	GEN NVARCHAR(50),
	dwh_create_date DATETIME2 DEFAULT GETDATE()
